dirnames = {'Y:\Research\SPrecordings\Rajat_Data\Data-SWIL\SWILRound4\SWIL18\RawData';
            };
for j=1:length(dirnames)
    ...
    for i=1:length(x)
        filename = x(i).name;
        [vis, hpc] = read_Intan_RHD2000_file_int_dualProbe_512Ch(fullfile(dirname,filename));
